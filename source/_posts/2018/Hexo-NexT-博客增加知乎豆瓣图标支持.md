...
![阿里巴巴矢量库](https://site-1256060851.file.myqcloud.com/images/2018/Hexo-NexT-博客增加知乎豆瓣图标支持/iconfont.png!500x)

然后，点击页面右上方 <i class="fa fa-fw fa-shopping-cart"></i> 进入购物车，选择「下载代码」。

![购物车下载代码](https://site-1256060851.file.myqcloud.com/images/2018/Hexo-NexT-博客增加知乎豆瓣图标支持/download.png!300x)
